document.addEventListener("DOMContentLoaded", () => {
  ...
  activitiesList.addEventListener("click", async (event) => {
    const unregisterButton = event.target.closest(".participant-delete-btn");
    if (!unregisterButton) {
      return;
    }

    const activityName = unregisterButton.dataset.activityName;
    const participantEmail = unregisterButton.dataset.participantEmail;
